    ...
    <footer className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-10 mt-4 border-t-[2px] border-[#96887d]">
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between  md:grid-cols-3">
          <img src={gift_logo} alt="logo-ct" className="w-[140px] mt-16" />
          <div className="flex gap-4 items-center justify-center sm:justify-start">
            {LINKS.map(({ title, items }) => (
              <ul key={title} className="mr-4">
                <Typography className="text-[#65451F] text-[14px] opacity-70">
                  {title}
                </Typography>
                {items.map((link) => (
                  <li key={link.text} className="flex items-center text-[14px]">
                    <Typography
                      as="a"
                      href="#"
          ...
          <div className="mt-8">
            <Typography
              variant="big"
              color="#65451F"
              className="mb-3 text-[#65451F] opacity-70"
            >
              Contact Us
            </Typography>
            ...
            <form>
              ...
              <div className="mb-4 flex space-x-4">
                <div className="w-1/2">
                  <label
                    htmlFor="name"
                    className="block text-sm font-medium text-[#4f4a4a]"
                  >
                    Name
                  </label>
                  <input
                    ...
                    id="name"
                    name="name"
                    className="mt-1 p-2 border border-[#4f4a4a] rounded-md w-full"
                  />
                </div>
                <div className="w-1/2">
                  <label
